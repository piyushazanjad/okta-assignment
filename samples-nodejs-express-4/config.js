...
var ISSUER = process.env.ISSUER || 'https://dev-48213059.okta.com/oauth2/default';
var CLIENT_ID = process.env.CLIENT_ID || '0oa4dpvj0uM3ouCrJ5d7';
var CLIENT_SECRET = process.env.CLIENT_SECRET || '{clientSecret}';
var SPA_CLIENT_ID = process.env.SPA_CLIENT_ID || '0oa4dpvj0uM3ouCrJ5d7';
